...
function add_theme_styles_scripts() {
	...
	wp_register_script( 'jQuery-UI', 'https://code.jquery.com/ui/1.12.1/jquery-ui.js', null, null, false );
	wp_enqueue_script('jQuery-UI');
  	...
  	wp_enqueue_style( 'rl-styles', get_template_directory_uri() . '/assets/css/vg-residuos-styles.css', array(), '', 'all');
  	...
  	if (is_page('Resultados busca')){
  		wp_enqueue_script( 'scripts-result', get_template_directory_uri() . '/assets/js/scripts-result.js', array(), '', true );
  	}
